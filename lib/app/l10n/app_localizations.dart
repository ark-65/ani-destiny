...
const _localizedValues = {
  'zh': {
    ...
    'sakuraSourceDescription': '预留给 SakuraAnime 风格 HTML 解析，第一版暂未启用。',
    ...
    'sourceSettingsSubtitle': '第一版推荐使用 Mock 数据源',
    ...
    'sourceSetTo': '数据源已切换为',
    'sourceV1Note': '第一版只有 Mock 数据源完整实现。其他 Adapter 会保留出来，方便后续迁移真实数据源。',
    'danmaku': '弹幕',
    'enabled': '启用',
    'opacity': '不透明度',
    'fontSize': '字号',
  ...
  'en': {
    ...
    'sourceSettingsSubtitle': 'Mock source is recommended for v1',
    ...
    'sourceV1Note':
        'Mock is the only fully implemented source in the first version. Other adapters stay visible for future real-source migration.',
    'danmaku': 'Danmaku',
    'enabled': 'Enabled',
    'opacity': 'Opacity',
    'fontSize': 'Font size',
  ...
  'ja': {
    ...
    'sakuraSourceName': 'Sakura Anime',
    'sakuraSourceDescription': '将来の SakuraAnime 形式 HTML 解析用スケルトンです。v1 では無効です。',
    ...
    'sourceSettingsSubtitle': 'v1 では Mock ソース推奨',
    ...
    'sourceV1Note': '初版では Mock ソースのみ完全実装です。他の Adapter は今後の実データ移行用に残しています。',
    'danmaku': '弾幕',
    'enabled': '有効',
    'opacity': '不透明度',
    'fontSize': '文字サイズ',
